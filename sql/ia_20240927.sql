...
CREATE TABLE txn_pay_record(
    `id` INT AUTO_INCREMENT COMMENT '支付记录ID' ,
    `customer_id` BIGINT   COMMENT '客户ID' ,
...
CREATE TABLE frs_face_record(
    `id` INT AUTO_INCREMENT COMMENT '人脸数据ID' ,
...
CREATE TABLE shop_product_type(
    `id` INT AUTO_INCREMENT COMMENT '商品类型ID' ,
...
CREATE TABLE shop_product_record(
    `id` INT AUTO_INCREMENT COMMENT '购物记录ID' ,
    `order_id` BIGINT   COMMENT '订单ID' ,
...
CREATE TABLE hotel_room_type(
    `id` INT AUTO_INCREMENT COMMENT '房型ID' ,
...
CREATE TABLE hotel_checkin_record(
    `id` INT AUTO_INCREMENT COMMENT '入住记录ID' ,
    `order_id` BIGINT   COMMENT '订单ID' ,
...
CREATE TABLE hotel_room_state_record(
    `id` INT AUTO_INCREMENT COMMENT '房态记录ID' ,
    `room_id` BIGINT   COMMENT '房间ID' ,
